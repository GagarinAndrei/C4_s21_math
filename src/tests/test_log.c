...
END_TEST
START_TEST(log_2) { ck_assert_ldouble_eq(s21_log(-1), log(-1)); }
END_TEST
START_TEST(log_3) { ck_assert_ldouble_eq(s21_log(S21_INF), log(S21_INF)); }
END_TEST
START_TEST(log_4) { ck_assert_ldouble_eq(s21_log(-S21_INF), log(-S21_INF)); }
END_TEST
START_TEST(log_5) { ck_assert_ldouble_eq(s21_log(S21_NAN), log(S21_NAN)); }
END_TEST
